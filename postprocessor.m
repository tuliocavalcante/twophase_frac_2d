...
function postprocessor(pressure,watersaturation,passo,coord,elem,metsat)
%
...
%existent file
fid = fopen(sprintf('%s\\%s\\%s\\%s\\Results\\%s',caso,malha,formethod,metsat,fname_vtk),'w'); 
