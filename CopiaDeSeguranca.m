function CopiaDeSeguranca( S_old,VPI,countime,step,watercut,oilrecovery,cumulateoil,time,metsat )

global caso malha formethod

fid = fopen(sprintf('%s\\%s\\%s\\%s\\Results\\CopiaDeSeguranca.txt',caso,malha,formethod,metsat),'w');
